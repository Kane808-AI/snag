...
const styles = StyleSheet.create({
  ...
  pendingLabel: { color: Colors.light.accent, fontSize: 11, fontWeight: '800' }, empty: { color: Colors.light.muted, fontSize: 14, paddingVertical: 30, textAlign: 'center' }, pressed: { opacity: 0.72, transform: [{ scale: 0.985 }] },
});
